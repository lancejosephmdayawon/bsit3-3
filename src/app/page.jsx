...
const Home = () => {
    ...
    return (
        <div className="w-full min-h-screen overflow-x-hidden bg-[#FFF8DE]/44">
            ...
            <main className="w-full h-screen relative overflow-hidden bg-[url('/assets/42622.jpg')] bg-cover bg-center bg-no-repeat">
                ...
                <div className="h-full w-full relative flex flex-col justify-center items-center z-20 backdrop-blur-[2px] backdrop-brightness-[0.85]">
                    <img
                    ...
                    <h1 className="lg:text-8xl text-6xl font-bold text-[#FFF8DE] drop-shadow-2xl text-center mt-6">
                        Welcome to Our Block
                    </h1>
                    
                    <div className="text-center mt-5">
                        <p className="text-[#FFF8DE] font-regular lg:text-xl drop-shadow-lg">
            ...
            <section ref={exploreSectionRef} className="w-full pt-12 pb-20 px-5 relative z-20">
